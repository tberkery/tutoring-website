...
router.post('/upload/:objectID', upload.single('profilePicture'), async (req, res) => {
    try {
...
router.put('/update/:objectID/:key', upload.single('profilePicture'), async (req, res) => {
    try {
        const objectID = req.params.objectID;
...
router.delete('/delete/:objectID/:key', async (req, res) => {
    try {
        const objectID = req.params.objectID;
        const key = req.params.key;
        if (!key) {
