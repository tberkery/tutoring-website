...
router.post("/course", async (req: any, res: any) => {
  try {
...
router.get("/course/findOne/:id", async (req: any, res: any) => {
...
router.get("/course/all", async (req: any, res: any ) => {
  try {
...
router.put("/course/:id", async (req: any, res: any) => {
...
router.delete("/course/:id", async (req: any, res: any) => {
    const id : number = req.params.id;
    try {
